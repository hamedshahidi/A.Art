...
public class StorageManager {
    ...
    private static final String KEY_PREFIX_ANCHOR = "anchor;";
    private static final String KEY_PREFIX_EXPO = "expo;";
    ...
    public void storeUsingShortCode(Activity activity,Float shortCode, String cloudAnchorId) {
        SharedPreferences sharedPrefs = activity.getPreferences(Context.MODE_PRIVATE);
        sharedPrefs.edit().putString( KEY_PREFIX_ANCHOR + shortCode, cloudAnchorId).apply();
    }
    ...
    */
    public String getCloudAnchorId(Activity activity, Float shortCode) {
        SharedPreferences sharedPrefs = activity.getPreferences(Context.MODE_PRIVATE);
